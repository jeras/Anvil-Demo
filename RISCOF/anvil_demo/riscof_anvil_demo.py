...
class anvil_demo(pluginTemplate):
    __model__ = "anvil_demo"
    ...
    def build(self, isa_yaml, platform_yaml):
        ...
        variables = f'HDL_DEFINES="{hdl_defines}" HDL_PARAMETERS="{hdl_parameters}"'
    ...
    def runTests(self, testList):
        ...
        for testname in testList:
            ...
            mem = os.path.join(test_dir, 'dut.hex')
